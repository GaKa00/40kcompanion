  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      <ModalContent>
        ...
        <ModalHeader textAlign="center">{book.title}</ModalHeader>
        <Flex justify="center">
          <ReactStars
            count={5}
            value={rating}
        ...
        <ModalBody>
          ...
          {summaryBool && (
            <>
              ...
              <Textarea placeholder="Press the save button to save your summary!" mb={4}  />{" "}
            </>
          )}
          {quoteBool && (
            <>
              <MdSave onClick={handleSavedQuote} />
              <Textarea placeholder="Press the save button above to save your quote. 
              Note. Write only one at a time!" mb={4}  />
            </>
          )}
        </ModalBody>
        <ModalFooter>
